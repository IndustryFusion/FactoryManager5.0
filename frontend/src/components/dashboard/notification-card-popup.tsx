  ...
  return (
    <>
      <Dialog
        ...
        header={notificationData.length > 0 ? <h3 className="m-0">{t("notifications")}</h3> : <h3 className="m-0">{t("dashboard:no_notifications")}</h3>}
