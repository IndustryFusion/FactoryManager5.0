...
describe('ShopFloorController', () => {
  ...
  const mockProvider = {
    ...
    update: jest.fn((id, data, token) => {
      if(Object.keys(data).length == 0) {
        ...
        error['response'] = response;
        throw error;
      } else if(data.hasOwnProperty("http://www.industry-fusion.org/schema#floorname")) {
        const response = {
          status: 404,
  ...
  const mockReq = {
    ...
    "type": "https://industry-fusion.org/types/v0.1/shopFloor",
    "properties": {
        "floor_name": "shopFloor A",
        "street": "street a",
        "zip": "12345",
        "country": "India",
  ...
  it('should add shopFloor site asset', async () => {
  ...
  it('should return all shopFloor site assets', async () => {
    (sessionService.getSessionToken as jest.Mock).mockResolvedValue(mockToken);
    const result = await controller.findAll(mockToken as any);
    expect(result).toEqual([])
  })

  it('should return shopFloor site specific asset', async () => {
    (sessionService.getSessionToken as jest.Mock).mockResolvedValue(mockToken);
  ...
  it('should delete shopFloor site specific asset', async () => {
    (sessionService.getSessionToken as jest.Mock).mockResolvedValue(mockToken);
  ...
  it('should update shopFloor site specific asset', async () => {
    (sessionService.getSessionToken as jest.Mock).mockResolvedValue(mockToken);
    const id = 'urn:ngsi-ld:factories:2:06';
    const mockData = {
      "http://www.industry-fusion.org/schema#floor_name": {
          "type": "Property",
          "value": "shopFloor B"
      }
  }
  ...
  it('patch should return 404 Resource not found', async () => {
    ...
    const id = 'urn:ngsi-ld:factories:2:06';
    const mockData = {
      "http://www.industry-fusion.org/schema#floorname": {
          "type": "Property",
          "value": "shopFloor B"
      }
  }
